			...
			<div class="contact-agileinfo">
				...
				<div class="col-md-4 contact-right wthree">
					<div class="contact-text w3-agileits">
						<h4>GET IN TOUCH :</h4>
						<p><i class="fa fa-map-marker"></i>Aayush Park 1 ,Near D.Y.Patil College </p>
						<p><i class="fa fa-phone"></i> Mobile Number :91 7030524098</p>
						
						<p><i class="fa fa-envelope-o"></i> Email : ninadshewale2002@gmail.com</p>
					</div> 
				</div> 
